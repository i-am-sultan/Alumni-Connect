...
exports.signIn = (req, res) => {
    ...
    User.findOne({email}, (err, user) => {
        ...
        const token = jwt.sign({ _id: user._id }, "SHHHSECRETSAUCE");
...
exports.signInAlumini = (req, res) => {
    ...
    Alumini.findOne({email}, (err, alumini) => {
        ...
        const token = jwt.sign({ _id: alumini._id }, "SHHHSECRETSAUCE");
        res.cookie("token", token, {expire: new Date() + 9999});
...
exports.signInMsde = (req, res) => {
    ...
    Msde.findOne({email}, (err, msde) => {
        ...
        const token = jwt.sign({ _id: msde._id }, "SHHHSECRETSAUCE");
        res.cookie("token", token, {expire: new Date() + 9999});
